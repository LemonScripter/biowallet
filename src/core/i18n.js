...
const STRINGS = {
  hu: {
    ...
    'genesis.recover.warning': '⚠ Írd fel a 24 szót papírra! Bezáráskor törlődik a memóriából és a vágólapról.',
  ...
  en: {
    ...
    'genesis.recover.warning': '⚠ Write down the 24 words on paper! They will be wiped from memory and clipboard on close.',
