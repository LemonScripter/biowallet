...
const STRINGS = {
  hu: {
    ...
    'liveness.blink':         '👁 Pislogjon 2-szer!',
    'liveness.turn_left':     '← Fordítsa fejét balra!',
    'liveness.turn_right':    '→ Fordítsa fejét jobbra!',
    'err.liveness.timeout':   'Az élő azonosítás időtúllépett — nézzen egyenesen a kamerába, és hajtsa végre a kért mozdulatot.',
    ...
    'btn.upgrade.v6':     'Biztonság erősítése (Argon2id)',
    'btn.upgrade.v6.sub': 'Vault v6 frissítés — memória-nehéz kulcslevezetés (64 MB, 3 menet)',
    'msg.upgrade.v6.confirm': 'Vault frissítése Argon2id kulcslevezetésre?\n\nA régi papírkód érvénytelen lesz — új papírkódot kell felírni.\nAz eszközfaktort újra kell regisztrálni a frissítés után.\n\nA folyamat ~2-3 másodpercig tart.\n\nFolytatja?',
    'msg.upgrade.v6.done':    'Vault sikeresen frissítve v6-ra (Argon2id). Töltse le az új .biowallet fájlt.',
    'msg.upgrade.v6.scanning':'Arc-scan az Argon2id frissítéshez (~3 mp)...',
    'err.upgrade.v6.fail':    'Vault frissítés sikertelen — próbálja újra.',
  ...
  en: {
    ...
    'liveness.blink':         '👁 Blink twice!',
    'liveness.turn_left':     '← Turn your head left!',
    'liveness.turn_right':    '→ Turn your head right!',
    'err.liveness.timeout':   'Liveness check timed out — look straight at the camera and perform the requested action.',
    ...
    'btn.upgrade.v6':     'Upgrade security (Argon2id)',
    'btn.upgrade.v6.sub': 'Vault v6 upgrade — memory-hard key derivation (64 MB, 3 passes)',
    'msg.upgrade.v6.confirm': 'Upgrade vault to Argon2id key derivation?\n\nYour current paper code will become invalid — you must write down a new one.\nDevice factor must be re-enrolled after the upgrade.\n\nThe process takes ~2-3 seconds.\n\nContinue?',
    'msg.upgrade.v6.done':    'Vault upgraded to v6 (Argon2id). Download the new .biowallet file.',
    'msg.upgrade.v6.scanning':'Face scan for Argon2id upgrade (~3 s)...',
    'err.upgrade.v6.fail':    'Vault upgrade failed — please try again.',
