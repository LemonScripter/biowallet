...
const STRINGS = {
  hu: {
    ...
    'liveness.turn':          '↔ Fordítsa fejét akármelyik irányba!',
    'err.liveness.timeout':   'Élő azonosítás időtúllépett — hajtsa végre a kért mozdulatot (pislogás vagy fejfordítás).',
    ...
    'msg.upgrade.v6.done':    'Vault sikeresen frissítve — Argon2id titkosítás aktív. Az eszközfaktort újra kell regisztrálni.',
  ...
  en: {
    ...
    'liveness.turn':          '↔ Turn your head to either side!',
    'err.liveness.timeout':   'Liveness check timed out — perform the requested action (blink or turn head).',
    ...
    'msg.upgrade.v6.done':    'Vault upgraded — Argon2id encryption active. Re-enroll your device factor if needed.',
