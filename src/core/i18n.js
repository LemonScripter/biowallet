...
const STRINGS = {
  hu: {
    ...
    'liveness.turn':          '↔ Mozgasd a fejed lassan jobbra, majd balra (élőség-ellenőrzés)…',
    ...
    'err.scan.stuck':         'A szkennelés megszakadt — próbáld újra. (Az adataid érintetlenek.)',
    ...
    'msg.vault.unsupported':  'Nem támogatott vault formátum — ez a verzió csak v5 tárcát nyit meg.',
    'msg.wallet.switch.scan': '🔒 {name} kiválasztva. Nyomd meg a KÉK „Megnyitás arc-scannel” gombot → mozgasd a fejed jobbra-balra (élőség-ellenőrzés) → arcazonosítás.',
    'msg.wallet.switch.incomplete': 'Ez a tárca nincs teljesen elmentve ebben a böngészőben — állítsd vissza egyszer a .P.json + .biowallet fájljaival, utána már váltható lesz.',
  ...
  en: {
    ...
    'liveness.turn':          '↔ Slowly move your head right, then left (liveness check)…',
    ...
    'err.scan.stuck':         'Scan interrupted — please try again. (Your data is safe.)',
    ...
    'msg.vault.unsupported':  'Unsupported vault format — this version only opens v5 wallets.',
    'msg.wallet.switch.scan': '🔒 {name} selected. Press the BLUE “Unlock with face scan” button → move your head left–right (liveness check) → face recognition.',
    'msg.wallet.switch.incomplete': 'This wallet isn\'t fully saved in this browser — restore it once with its .P.json + .biowallet files, then it becomes switchable.',
