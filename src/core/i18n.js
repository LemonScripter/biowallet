...
const STRINGS = {
  hu: {
    ...
    'msg.wallet.switch.incomplete': 'Ez a tárca hiányosan van mentve — töltsd be a .biowallet fájlját.',
  ...
  en: {
    ...
    'msg.wallet.switch.incomplete': 'This wallet\'s saved data is incomplete — load its .biowallet file.',
