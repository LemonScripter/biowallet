...
const STRINGS = {
  hu: {
    ...
    'sss.paper.modal.body':  'Ez a 64 karakteres kód a 3. faktorod. A vault fájlban <strong>nem tárolódik</strong>. Ha elveszted az eszközödet <em>és</em> ezt a kódot is, a vault örökre zárolva marad.',
    ...
    'sss.lock.paper.ph':     '64 hex karakter — pl. 3a9f…',
    ...
    'msg.vault.v4.no.face.warn': 'Figyelem: eszköz+papír kombinációval nyílt meg, arc nélkül. Javasolt a vault v5-re frissítése az arc re-enrollment érdekében.',
    'msg.vault.v4.legacy.warn':  'Ez egy v4-es vault (nincs genesis HMAC). A biztonság növeléséhez frissítse v5-re.',
    ...
    'msg.reenroll.mandatory.sub': 'A tárcát papír + eszköz hitelesítéssel nyitottad meg. Az arc-alapú belépés rögzítéséhez most be kell olvasnod az arcodat. Ez nem kihagyható — a genesis.dna lánc integritásához szükséges.',
  ...
  en: {
    ...
    'sss.paper.modal.body':  'This 64-character code is your 3rd factor. It is <strong>not stored</strong> in the vault file. If you lose your device <em>and</em> this code, the vault is permanently locked.',
    'sss.paper.copy':        'Copy',
    ...
    'sss.lock.paper.ph':     '64 hex chars — e.g. 3a9f…',
    ...
    'msg.vault.v4.no.face.warn': 'Warning: vault opened with device+paper, no biometric. Consider upgrading to v5 for face re-enrollment support.',
    'msg.vault.v4.legacy.warn':  'This is a v4 vault (no genesis HMAC). Upgrade to v5 for stronger tamper protection.',
    ...
    'msg.reenroll.mandatory.sub': 'The vault was opened using paper + device authentication. To enable face-based access on this browser, you must scan your face now. This step cannot be skipped — it is required to maintain genesis.dna chain integrity.',
