...
export const BUILTIN_NETWORKS = [
  ...
  { key: 'polygon',   name: 'Polygon',    chainId: 137,      rpc: 'https://polygon-bor-rpc.publicnode.com',      explorer: 'https://polygonscan.com/tx/',           nativeSymbol: 'POL',  blockscout: 'https://polygon.blockscout.com',      testnet: false },
